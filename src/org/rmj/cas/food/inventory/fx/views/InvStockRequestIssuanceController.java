...
//                    isBillClicked(pnRow - 1);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        poTrans.setFormType(1);//0 Approval Form//1 Issuance Form//2 Purchase From
        initMasterGrid();
        initDetailGrid();
        initActionButton();
        initFieldListener();
...
//        }
    ...
    private boolean printDetail() {
        ...
        try {
            ...
            params.put("sDestinat", ListData.get(pnRow).getIndex04());
            params.put("sReportDt", ListData.get(pnRow).getIndex03());
...
//        }
    ...
    private void loadDetail() {
        ...
        for (lnCtr = 0; lnCtr <= lnRow - 1; lnCtr++) {
            ...
            DetailData.add(new TableModel(String.valueOf(lnCtr + 1),
                    ...
                    CommonUtils.NumberFormat(Double.valueOf(poTrans.getDetail(pnRow, lnCtr, "nOrderQty").toString()), "0.00"),
                    CommonUtils.NumberFormat(Double.valueOf(poTrans.getDetailOthers(pnRow, lnCtr, "nIssueQty").toString()), "0.00"),
    ...
    private void setDetailInfo() {
        if (pnRowDetail >= 0) {
            ...
            txtDetail10.setText(String.valueOf(poTrans.getDetailOthers(pnRow, pnRowDetail, "nIssueQty")));
    ...
    private boolean showInvTransfer() {
        ...
        for (int lnCtr = 0; lnCtr <= lnItem - 1; lnCtr++) {
            if ((Double) poTrans.getDetailOthers(pnRow, lnCtr, "nIssueQty") > 0) {
                ...
                Double nIssueQty = (Double) poTrans.getDetailOthers(pnRow, lnCtr, "nIssueQty");
...
//                loInvTransfer.setDetail(lnRow, "dExpiryDt", paDetail.get(lnCtr).getDateExpiry());
                ...
                loInvTransfer.setDetail(lnRow, "nQuantity", nIssueQty);

...
//        myBox.getChildren().clear();
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        switch (lsButton) {
            ...
            case "btnImport":
                ...
                break;
            case "btnExport":
                if (poTrans.ExportData((Stage) anchorField.getScene().getWindow())) {
                }
    ...
    private void loadRecord() {
        ...
        if (loInv != null) {
            txtField04.setText((String) loInv.getMaster("sDescript"));
        }
    ...
    private void getMaster(int fnIndex) {
        switch (fnIndex) {
            ...
            case 4:
                ...
                if (loInventoryType != null) {
                    txtField04.setText((String) loInventoryType.getMaster("sDescript"));
                }
                break;
        }
    }

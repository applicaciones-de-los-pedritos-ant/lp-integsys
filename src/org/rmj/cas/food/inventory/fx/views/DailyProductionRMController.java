...
public class DailyProductionRMController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        poTrans = new DailyProductionRM(poGRider, poGRider.getBranchCode(), false);
    ...
    private void initGrid(){
        ...
        TableColumn index05 = new TableColumn("Expiry");
        TableColumn index06 = new TableColumn("QOH");
        TableColumn index07 = new TableColumn("Reqd");
        TableColumn index08 = new TableColumn("Used");
        ...
        index06.setPrefWidth(85); index04.setStyle("-fx-alignment: CENTER;");
        index07.setPrefWidth(85); index04.setStyle("-fx-alignment: CENTER;");
        index08.setPrefWidth(85); index04.setStyle("-fx-alignment: CENTER;");
        ...
        index06.setSortable(false); index04.setResizable(false);
        index07.setSortable(false); index04.setResizable(false);
        index08.setSortable(false); index04.setResizable(false);
    ...
    private DailyProductionRM poTrans;
...
//                        poTrans.setDetail(pnRow, "dExpiryDt" , CommonUtils.toDate(pxeDateDefault));
                 ...
                 case 7: /*dExpiryDt*/
                    if (CommonUtils.isDate(txtDetail.getText(), pxeDateFormat)){
                        poTrans.setDetail(pnRawdata, "dExpiryDt", CommonUtils.toDate(txtDetail.getText()));
                    } else{
                        ShowMessageFX.Warning("Invalid date entry.", pxeModuleName, "Date format must be yyyy-MM-dd (e.g. 1991-07-07)");
                        poTrans.setDetail(pnRawdata, "dExpiryDt" , CommonUtils.toDate(pxeDateDefault));
                    }
                    txtDetail.setText(CommonUtils.xsDateMedium((Date)poTrans.getDetail(pnRawdata, "dExpiryDt")));
                    return;
                case 4:/*nQuantity*/
                    ...
                    poTrans.setDetail(pnRow, "nQtyReqrd", y);
                    break;
                case 5:/*nGoalQtyx*/
                    /*This must be numeric*/
                    double x =0;
                    ...
                    poTrans.setDetail(pnRow, "nQtyUsedx", x);
                    break;
            }
    ...
    private void loadDetail(){
        ...
        for(lnCtr = 0; lnCtr <= lnRow -1; lnCtr++){
            data.add(new TableModel(String.valueOf(lnCtr + 1), 
                                    ...
                                    (String) poTrans.getDetailOthers(lnCtr, "nQtyOnHnd"),

...
//    @FXML private MenuItem mnu_DailyProduction;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        if ("IntegSys»Telecom".contains(poGRider.getProductID())){
            ...
            mnuDailyProductionFG.setVisible(poGRider.getBranchCode().contains("P"));
            mnuDailyProductionRM.setVisible(poGRider.getBranchCode().contains("P"));
    ...
    public void loadRecord(){
        ...
        try {
            ...
            Logger.getLogger(MDIMainControllerNeo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        dragNode(stack);
    ...
    public Object getContoller(String fsValue){
        switch (fsValue){
            ...
            case FoodInventoryFX.pxeDailyProdFG:
                DailyProductionFGController loDailyProductionFGObj = new DailyProductionFGController();
                loDailyProductionFGObj.setGRider(poGRider);
                
                return loDailyProductionFGObj;
            case FoodInventoryFX.pxeDailyProdRM:
                DailyProductionRMController loDailyProductionRMObj = new DailyProductionRMController();
                loDailyProductionRMObj.setGRider(poGRider);
                
                return loDailyProductionRMObj;
...
//        setDataPane(fadeAnimate(FoodInventoryFX.pxePOReceiving));
    ...
    @FXML
    private void mnuDailyProductionFG(ActionEvent event) throws IOException {
//        setDataPane(fadeAnimate(FoodInventoryFX.pxePOReceiving));
        loadScene(FoodInventoryFX.pxeDailyProdFG);
    }
    
    @FXML
    private void mnuDailyProductionRM(ActionEvent event) throws IOException {
//        setDataPane(fadeAnimate(FoodInventoryFX.pxePOReceiving));
        loadScene(FoodInventoryFX.pxeDailyProdRM);
    }
